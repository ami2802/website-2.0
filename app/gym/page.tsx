...
export default function GymPage() {
  ...
  const [allExercises, setAllExercises] = useState<{day: string, group: string, exercises: Exercise[]}[]>([])
  ...
  return (
    <div style={{ padding: 16, display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%' }}>
